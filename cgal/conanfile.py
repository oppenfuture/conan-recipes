...
class CgalConan(ConanFile):
    ...
    requires = "mpfr/4.0.2", "boost/1.73.0", "eigen/3.2.10@oppen/testing"
    generators = "cmake"
    ...
    def source(self):
        tools.get("https://github.com/CGAL/cgal/releases/download/releases/CGAL-5.0.2/CGAL-5.0.2.zip", sha256="4d281e482449de3a7415cfc117ace2341427ffc4a03cb0806794531cacdde38f")
